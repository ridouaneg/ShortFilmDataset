...
def parse_args():
    ...
    parser.add_argument("--video_path", type=str, default="../../../data/media/test.mkv")
...
def main(args):
    ...
    tokenizer, model, image_processor, _ = load_pretrained_model(model_name, None, "llava_qwen", device_map="auto", load_4bit=True)
